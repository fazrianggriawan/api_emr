...
class BiodataPasien extends BaseController
{
    ...
    public function doPrint($data)
    {
        ...
        try {
            ...
            $pdf->Cell($widthCellData, $heightCell,': '.LibApp::dateHuman(substr($data->date_created, 0, 10)), $border);
            ...
            $pdf->Cell($widthCellData, $heightCell,': '.LibApp::dateHuman($data->tgl_lahir), $border);
